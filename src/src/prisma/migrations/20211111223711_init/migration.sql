...
CREATE TABLE `character` (
    ...
    `max_san_points` INTEGER NOT NULL DEFAULT 0,
    `current_par_points` INTEGER NOT NULL DEFAULT 0,
    `max_par_points` INTEGER NOT NULL DEFAULT 0,
    `current_picture` INTEGER NOT NULL DEFAULT 1,
    `is_dead` BOOLEAN NOT NULL DEFAULT false,
    `created_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `money` INTEGER NULL,
    `current_pe_points` INTEGER NOT NULL DEFAULT 0,
    `max_pe_points` INTEGER NOT NULL DEFAULT 0,
